...
import haushaltsbuch from "./../main.js";   // siehe "haushaltsbuch.eintrag_hinzufuegen(formulardaten);"

/**
 * Die Klasse "Eingabeformular" stellt alle Eigenschaften und Methoden 
 * des Eingabeformaulars inkl. HTML und Events zur Verfügung
 */
export default class Eingabeformular {

    /**
     * Konstruktur generiert bei Instanziierung der Klasse "Eingabeformular"
    ...
    /**
     * Die private Methode extrahiert (holt) die Daten,
     * die im Eingabeformular im Submit-Event eingegeben wurden.                             
     * @param {Event} submit_Objekt - Submit-Event vom Eingabeformular
